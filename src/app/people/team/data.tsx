...
const team = [
  {
    position: "Magisters",
    names: "Jenifer Bratter and Noe Perez",
    body: [
      "We are Jenifer Bratter and Noe Perez, the Magisters of McMurtry College, the best college on campus.  There are three things that make McMurtry superior above all other colleges - the people, the people, the people!  Murts are the most wonderful people you will meet at this University! Our mission as Magisters is to help students find connections to others, engage their interests, and see this place as home. We are entering our fifth year as Magisters!",
      "We love getting to know students and having them over at our home for food and fun, but also just chatting to get to know your hopes and dreams. To get that started, here’s a little about us: Noe and Jenifer have been married for 22 years.  We love to travel, cook, and hang out with friends.  Our most recent travels were to Yellowstone National Park.  We are a couple from all over – Jenifer was born in Brooklyn and Noe hails from South Texas (“the Valley”) and we met at the University of Texas at Austin in the graduate program in Sociology during a conflict about a desk – yes, please ask.",
      "Jenifer is a Professor in the Sociology Department specializing in race and ethnicity and its impact on identity, interpersonal relationships, and life chances. She has been working at Rice since 2006, and she enjoys the creative and intellectually dazzling graduate and undergraduate students.",
      "Noe is a freelance researcher. He loves biking as a way to exercise (ask him about the Bike paths in Houston!), getting to know the Rice community, carpentry, cooking--especially dishes that remind folks of home--and farmer’s markets.",
      "We have two boys.  Ricardo (age 19) is entering his second year at Trinity University. His passions are Parkour, weight lifting, climbing, and his goal is to study architecture and urban studies.  Our son Sam (age 14), who is starting high school this fall, is a guitar player, video gamer, chess enthusiast, and a programmer.",
      "Last, but not least, is our dog, Sunshine Charlie, who loves people (and belly rubs!). He’s a Siberian husky mix that we adopted in Spring of 2022 so he has literally lived his entire life at McMurtry.",
      "Welcome to McMurtry!",
    ],
    image: "/team/magisters.png",
  },
  {
  ...
  },
  {
    ...
    image: "/team/deirdre.png",
  },
];

export { title, description, team };
